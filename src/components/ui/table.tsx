...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("[&_tr]:border-b border-slate-100 bg-slate-50/75", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-8.5 px-3 py-1.5 text-left align-middle text-xs font-semibold text-slate-500 [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "px-3 py-2 align-middle text-xs text-slate-700 leading-normal [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
